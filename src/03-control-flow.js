 ...
 *  //> 19
 */
function findLarger(a, b) {return a > b ? a : b}
 ...
 *  //> "tie"
 */
function findLargerOrTie(a, b) { return a === b ? "tie" : a > b ? a : b }
...
function calculateLetterGrade(grade) {
  ...
  if(grade >= 60) result = "D";
  if(grade >= 70) result = "C";
  if(grade >= 80) result = "B";
...
function animalCounts(animal, numberOfAnimals) {
  let resultStr = `${numberOfAnimals} ${animal}${numberOfAnimals > 1 ? 's' : ""}`
  return resultStr
}
 ...
 *  //> "Even"
 */
function evenOrOdd(a) { return a % 2 === 0 ? 'Even' : "Odd"}
