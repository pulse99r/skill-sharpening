 ...
 */
function averageThree(a,b,c) {return (a + b + c)/3}
 ...
 *  //> -50
 */
function flipSign(a) {return a * -1}
 ...
 */
function joinStringsWithSpaces(a,b,c,d,e) {return `${a} ${b} ${c} ${d} ${e}`}
