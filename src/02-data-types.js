 ...
 *  //> 4
 */
function getLengthOfString(str) {return str.length}
 ...
 *  //> 111
 */
function convertToNumber(val) {return Number(val)}
 ...
 *  //> "99"
 */
function convertToString(val) {return String(val)}
 ...
 *  //> "HELLO THERE"
 */
function convertToShoutingText(text) {return text.toUpperCase()}
 ...
 *  //> "hello there"
 */
function convertToWhisperText(text) {return text.toLowerCase()}
 ...
 *  //> false
 */
function checkIfCharacterIsInString(text, character) {return text.includes(character)}
 ...
 *  //> false
 */
function isTruthy(val) {return !!undefined || !!val}
 ...
 *  //> false
 */
function isFalsy(val) {return !val ? true: false}
